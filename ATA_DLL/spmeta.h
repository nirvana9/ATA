...
// gain table
    typedef	struct
    {
        char  bEnable;    // retrun if support gain table
    } l4aud_gaintable_cnf;
...
// Gain Table
    ...
    META_RESULT  __stdcall SP_META_NVRAM_Compose_AudioGainTable(const AUDIO_GAIN_TABLE_STRUCT *param, char *buf, const int buf_len);
    META_RESULT  __stdcall SP_META_NVRAM_Decompose_AudioGainTable(AUDIO_GAIN_TABLE_STRUCT *param, char *buf, const int buf_len);
