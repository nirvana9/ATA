...
#include "StdAfx.h"
#include "..\header\ATA_DLL_TestItem_RTC.h"

CTestItem_RTC::CTestItem_RTC(ATA_DLL_Handle *current_handle, int timeout, E_ATDLL_TEST_ITEM_COUNT item, char *testName)
    : CTestItem_Interface(current_handle, timeout, item, testName)
{
}

CTestItem_RTC::~CTestItem_RTC()
{
}


E_ATADLL_RESULT CTestItem_RTC::StartTest ()
{
	E_ATADLL_RESULT testResultCode;
    ClearATResPool();
    test_handle->m_commonCFG.cbTestProgess (test_handle->handle_index, E_RTC, 10);
