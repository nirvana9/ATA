...
public:
    ...
    BOOL	GetListModified()
    {
        return m_bListModified;    //+++
    }
    ...
    void	SetCellPadding(int nPadding)
    {
        m_nPadding = nPadding;    //+++
    }
    ...
    void	SetHeaderAlignment(UINT nFormat)
    {
        m_HeaderCtrl.SetAlignment(nFormat);    //+++
    }
    void	SetHeaderTextColor(COLORREF rgbText)
    {
        m_HeaderCtrl.SetTextColor(rgbText);    //+++
    }
    ...
    BOOL	SetItemText(int nItem,
                        ...
                        COLORREF crText,
                        COLORREF crBackground);
    void	SetListModified(BOOL bListModified)
    {
        m_bListModified = bListModified;    //+++
    }
